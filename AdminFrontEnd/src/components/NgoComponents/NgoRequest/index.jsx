...
export const NgoRequest = ({ngoRequest}) => {
  return (
    <>
      {/* Page title */}
      ...
      >
        <Grid item xs={12} md={12} lg={12} xl={12}>
            <Box textAlign={"center"} >
                    <img 
                    src={ngoRequest.ngoImageLink?ngoRequest.ngoImageLink:'/images/admin/defaultProfile.jpg' }
                    alt="profile" 
          ...
          <NgoInformation ngoRequest = {ngoRequest} />
          <AssociateInformation ngoRequest = {ngoRequest}/>
        </Grid>
      </Grid>
    </>
  )

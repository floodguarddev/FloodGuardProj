...
export const SearchAndFilter = ({query, setQuery, offset, limit, setUsersRefresh}) => {
    //References//
    ...
    const applyFilter = ()=>{
      let newQuery = {};
      newQuery = {...newQuery,...donationsRef.current.applyFilter()};
      ...
      <Collapse in={showFilters}>
            ...
            <Box component="form" noValidate sx={{ mt: 2,  mb: 2}}>
                <Grid container spacing={2}>
                    <StringFilter ref={nameRef} title = {"Name"} field={"name"}/>
                    <StringFilter ref={emailRef} title = {"Email"} field={"email"}/>
                    <NumberFilter ref={donationsRef} title = {"Donations"} field={"donations"}/>
                </Grid>
            </Box>
            </CardContent>

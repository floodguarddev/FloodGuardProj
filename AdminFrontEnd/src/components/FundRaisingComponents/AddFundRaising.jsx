...
import { addFundRaising } from "../../services/fund_raising.services";
import createFileList from "create-file-list";
export function AddFundRaising() {
  ...
  const addFundRaisingFunc = async () => {
    ...
    try{
      ...
      await addFundRaising(token, ngoId, formData);

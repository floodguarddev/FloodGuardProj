...
import { ViewNewsList } from "../../components/NewsComponents/ViewNewsList";
import EditNews  from "@/components/NewsComponents/EditNews";
import { SearchAndFilter } from '../../components/NewsComponents/SearchAndFilter';
// End Create new news Modal
...
export default function NewsList() {
  //News List Refresher
  const [newsRefresh, setNewsRefresh] = React.useState(true);
  //Query//
  ...
  return (
    <>
      ...
      <div className={styles.pageTitle}>
        <h1>Flood News List</h1>
        <ul>
          <li>
            <Link to="/">Dashboard</Link>
          </li>
          <li>Flood News List</li>
        </ul>
      </div>

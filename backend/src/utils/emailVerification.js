...
async function sendUserVerficationEmail(email){
    ...
    let emailBody = '<html><h2>Email Verification of Emumba To Do List</h2><p>Please, verify your email in emumba using the given link</p><a href = "http://localhost:'+process.env.PORT+'/users/verifyEmail?token='+emailToken+'"><button>Verify Email</button></a></html>';
